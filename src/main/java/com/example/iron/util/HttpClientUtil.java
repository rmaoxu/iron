...
public class HttpClientUtil {
     ...
     * @return
     */
    public static HttpResponse getHttps(String url) {
     ...
     * @return
     */
    public static HttpResponse getHttps(String url, Map<String, Object> params) {
        return doGet(url, params, false);
    }

    public static HttpResponse doGet(String url, Map<String, Object> params, boolean bl) {
     ...
     * @return
     */
    public static HttpResponse postJson(String url, String jsonStr) {
     ...
     * @return
     */
    public static HttpResponse doPostSSL(String url, Map<String, Object> params) {
        log.info("____请求参数:" + params.toString());
        return HttpClient.domain(httpClient -> {
            HttpPost httpPost = httpPostHandler(url, params);
            return execute(httpClient, httpPost);
     ...
     * @return
     */
    public static HttpResponse doPostSSL(String apiUrl, Object json) {
    ...
    private static HttpResponse execute(CloseableHttpClient httpClient, HttpRequestBase httpGetOrPost) {
